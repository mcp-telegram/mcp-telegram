...
4. Ask Claude: **"Run telegram-login"** -- a QR code will appear. If the image is not visible, the QR is saved to `~/.mcp-telegram/qr-login.png`. Scan it in Telegram (**Settings > Devices > Link Desktop Device**).
